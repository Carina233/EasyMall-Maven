...
<html>
	...
	<table width="799" height="80" border="1" cellpadding="0" cellspacing="0" bordercolor="#d8d8d8">
				...
				<tr>
					<td><img src="${ pageContext.request.contextPath }${prod.imgurl}" width="90" height="90" class="prodimg" /></td>
					<td>${prod.name }</td>
					<td>${prod.price }元</td>
					...
					<td>修改</td>
					<td>
						<a href="${ pageContext.request.contextPath }/admin/OnSale?id=${prod.id}">上架</a>
						<br/>
						<a href="${ pageContext.request.contextPath }/admin/OffSale?id=${prod.id}">下架</a>
					</td>
